...
:UACPrompt
	...
	echo UAC.ShellExecute "cmd.exe", "/c %temp%\PIMC\32.bat", "", "runas", 0 >> "%temp%\PIMC\getadmin.vbs"
...
REM   =============== delete folder ===============	
	...
	msiexec.exe /i "%temp%\PIMC\er2_x32.msi" /QN INSTALLDIR="%DIRECTORY%\" TARGETIP=%IP%
